...
public class ques4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                Intent intent=new Intent(ques4.this, finish.class);
        ...
        String[] q1={"Ringgit is the currency of:", "What runs between the North Sea and the Atlantic Ocean?", "The Southern Ocean (surrounding Antarctica) does not border which landmass?", "Colombia border which two oceans?"};
        Random r=new Random();
        int randomQues=r.nextInt(q1.length);
        final TextView textView=(TextView) findViewById(R.id.textView3);
        textView.setText(q1[randomQues]);
        //Button Text Randomization
        if (q1[randomQues].equals("Ringgit is the currency of:"))
        {
            final Button button3=(Button) findViewById(R.id.button3);
            button3.setText("Brunie");
            final Button button4=(Button) findViewById(R.id.button4);
            button4.setText("Bahrain");
            final Button button5=(Button) findViewById(R.id.button5);
            button5.setText("Cyprus");
            final Button button6=(Button) findViewById(R.id.button6);
            button6.setText("Jordan");
        }
        else if (q1[randomQues].equals("What runs between the North Sea and the Atlantic Ocean?"))
        {
            final Button button3=(Button) findViewById(R.id.button3);
            button3.setText("The English Channel");
            final Button button4=(Button) findViewById(R.id.button4);
            button4.setText("Labrador Sea");
            final Button button5=(Button) findViewById(R.id.button5);
            button5.setText("James Bay");
            final Button button6=(Button) findViewById(R.id.button6);
            button6.setText("Greenland Sea");
        }
        else if (q1[randomQues].equals("The Southern Ocean (surrounding Antarctica) does not border which landmass?"))
        {
            final Button button3=(Button) findViewById(R.id.button3);
            button3.setText("The Eurasian");
            final Button button4=(Button) findViewById(R.id.button4);
            button4.setText("Americas");
            final Button button5=(Button) findViewById(R.id.button5);
            button5.setText("Australia");
            final Button button6=(Button) findViewById(R.id.button6);
            button6.setText("Antarctica");
        }
        else if (q1[randomQues].equals("Colombia border which two oceans?"))
        {
            final Button button3=(Button) findViewById(R.id.button3);
            button3.setText("Atlantic and The Pacific");
            final Button button4=(Button) findViewById(R.id.button4);
            button4.setText("Antarctica and Atlantic");
            final Button button5=(Button) findViewById(R.id.button5);
            button5.setText("Antarctic and The Pacific");
            final Button button6=(Button) findViewById(R.id.button6);
            button6.setText("Arctic and The Pacific");
        }
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(ques4.this);
        ...
        builder.setMessage("Do you want to exit?")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent gohome=new Intent(ques4.this, MainActivity.class);
