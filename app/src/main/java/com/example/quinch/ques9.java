...
public class ques9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                Intent intent=new Intent(ques9.this, finish.class);
        ...
        String[] q1={"The first death anniversary day of Sri Rajiv Gandhi was observed as?", "India celebrates February 28 as 'National Science Day' because on this day", "Who co-founded Hotmail in 1996 and then sold the company to Microsoft?", "Compact discs, (according to the original CD specifications) hold how many minutes of music?"};
        Random r=new Random();
        int randomQues=r.nextInt(q1.length);
        final TextView textView=(TextView) findViewById(R.id.textView3);
        textView.setText(q1[randomQues]);
        //Button Text Randomization
        if (q1[randomQues].equals("The first death anniversary day of Sri Rajiv Gandhi was observed as?"))
        {
            final Button button3=(Button) findViewById(R.id.button3);
            button3.setText("Anti-Terrorism Day");
            final Button button4=(Button) findViewById(R.id.button4);
            button4.setText("Secularism Day");
            final Button button5=(Button) findViewById(R.id.button5);
            button5.setText("Peace and Love Day");
            final Button button6=(Button) findViewById(R.id.button6);
            button6.setText("National Integration Day");
        }
        else if (q1[randomQues].equals("India celebrates February 28 as 'National Science Day' because on this day"))
        {
            final Button button3=(Button) findViewById(R.id.button3);
            button3.setText("C.V. Raman discovered 'Raman Effect'.");
            final Button button4=(Button) findViewById(R.id.button4);
            button4.setText("Nehru laid foundation of Science labs.");
            final Button button5=(Button) findViewById(R.id.button5);
            button5.setText("First Indian Space Craft was launched.");
            final Button button6=(Button) findViewById(R.id.button6);
            button6.setText("Vikram Sarabhai was born.");
        }
        else if (q1[randomQues].equals("Who co-founded Hotmail in 1996 and then sold the company to Microsoft?"))
        {
            final Button button3=(Button) findViewById(R.id.button3);
            button3.setText("Sabeer Bhatia");
            final Button button4=(Button) findViewById(R.id.button4);
            button4.setText("Shawn Fanning");
            final Button button5=(Button) findViewById(R.id.button5);
            button5.setText("Ada Byron Lovelace");
            final Button button6=(Button) findViewById(R.id.button6);
            button6.setText("Ray Tomlinson");
        }
        else if (q1[randomQues].equals("Compact discs, (according to the original CD specifications) hold how many minutes of music?"))
        {
            final Button button3=(Button) findViewById(R.id.button3);
            button3.setText("74 mins");
            final Button button4=(Button) findViewById(R.id.button4);
            button4.setText("56 mins");
            final Button button5=(Button) findViewById(R.id.button5);
            button5.setText("60 mins");
            final Button button6=(Button) findViewById(R.id.button6);
            button6.setText("90 mins");
        }
    ...
    public void search(View view)
    {
        ...
        //Alert Dialog
        final Dialog dialog=new Dialog(ques9.this);
    ...
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(ques9.this);
        ...
        builder.setMessage("Do you want to exit?")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent gohome=new Intent(ques9.this, MainActivity.class);
